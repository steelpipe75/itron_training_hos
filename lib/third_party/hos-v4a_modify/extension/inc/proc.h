#if 1
/**
 * hos-v4a の kernel\include\arch\proc\win\win32\proc.h
 * をもとに改変
 */
#endif
/**
...
typedef struct _kernel_t_ictxcb
{
	...
	HANDLE				hTerCtxEvent;		/**< %jp{システム終了通知用イベントハンドル} */
#endif
} _KERNEL_T_ICTXCB;
...
#if 1
void    _kernel_ter_ctx(void);																/**< %jp{実行コンテキストの終了} */
#endif
...
#if 1
#define _KERNEL_TER_CTX()	_kernel_ter_ctx()
#endif
